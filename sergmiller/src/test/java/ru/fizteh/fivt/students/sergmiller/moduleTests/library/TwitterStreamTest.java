...
import ru.fizteh.fivt.students.sergmiller.twitterStream.TwitterStream;
...
//
    ...
    public void testPrintTwitterLimitedAllTweets() throws Exception {
        ...
        TwitterStream twitterStream7 = new TwitterStream();
        List<String> currentTweets = twitterStream7.getTwitterLimited(
